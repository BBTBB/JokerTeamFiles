...
if DevAbs:get(JokerTeam.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(JokerTeam.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAbs:get(JokerTeam.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
JokerTeamName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if JokerTeamName then 
JokerTeamNames = DevAbs:smembers(JokerTeam.."Abs:Mute:Names"..msg.chat_id_) or ""
if JokerTeamNames and JokerTeamNames[1] then 
for i=1,#JokerTeamNames do 
if JokerTeamName:match("(.*)("..JokerTeamNames[i]..")(.*)") then 
...
DevAbs:set(JokerTeam.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(JokerTeam.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
