...
if result.id_ then 
local abbs = DevAbs:get("JokerTeamTEAM:Name"..result.id_)
if not result.first_name_ then 
if abbs then 
DevAbs:del("JokerTeamTEAM:Name"..result.id_) 
end
end
...
DevAbs:set("JokerTeamTEAM:Name"..result.id_, result.first_name_)  
end
end
end,nil) 
end
